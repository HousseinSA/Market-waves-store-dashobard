const RecentActivity = () => {
  return (
    <div className="self-stretch rounded-mini bg-grayscale-white shadow-[0px_2px_10px_rgba(0,_0,_0,_0.25)] flex flex-col items-center justify-center text-left text-[0.88rem] text-grayscale-black font-poppins">
      <div className="self-stretch flex flex-col items-center justify-center py-[0.63rem] px-[0rem] gap-[0.63rem]">
        ...
        <div className="self-stretch h-[2.23rem] overflow-hidden shrink-0 flex flex-row items-center justify-center py-[0.94rem] px-[2rem] box-border gap-[1.56rem]">
          <div className="flex-1 flex flex-row items-center justify-start gap-[1.56rem]">
            <img
              ...
              alt=""
              src="/controls--checkbox--active.svg"
            />
